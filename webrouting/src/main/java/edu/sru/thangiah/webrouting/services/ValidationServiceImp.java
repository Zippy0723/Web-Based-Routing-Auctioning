...
public class ValidationServiceImp {
	...
	public Shipments validateShipment(Hashtable<String, String> hashtable, HttpSession session) {
		...
		if(!(acceptedFreightTerms.contains(fullFreightTerms))) {
			...
			session.setAttribute("message", "<span style='color:red'>Full Freight Term must be an accepted term.</span>");
			return null;
		}
		...
		if(!(scac.length() <= 4 && scac.length() >= 2) || !(scac.matches("^[a-zA-Z0-9]+$"))) {
			if (!(scac.equals("") || scac == null)) {
					...
					session.setAttribute("message", "<span style='color:red'>SCAC must be between 2 and 4 characters long or empty.</span>");
					return null;
				}	
			}
		...
		if(!(paidAmount.length() <= 16 && paidAmount.length() > 0) || !(freightBillNumber.matches("^[0-9]*\\.?[0-9]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Paid Amount must be between 1 and 16 numbers long.</span>");
			return null;
		}
		...
		if(!(freightBillNumber.length() <= 32 && freightBillNumber.length() > 0) || !(freightBillNumber.matches("^[0-9]*\\.?[0-9]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Freight Bill Number must be between 1 and 32 numbers long.</span>");
			return null;
		}
		...
		if (!(clientName.length() <= 64 && clientName.length() > 0) || !(clientName.matches("^[a-zA-Z0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Client Name must be between 1 and 64 characters and alphanumeric.</span>");
			return null;
		}
		...
		if(!(clientMode.equals("LTL") || clientMode.equals("FTL"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Client Mode must be LTL or FTL.</span>");
			return null;
		}
		...
		if(!(date.length() <= 12 && date.length() > 0 && date.matches("^\\d{2}-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-\\d{4}$"))) { 
			...
			session.setAttribute("message", "<span style='color:red'>Date must be between 1 and 12 characters and formated MM/DD/YYYY.</span>");
			return null;
		}
		...
		if(!(commodityClass.length() <= 12 && commodityClass.length() > 0) || !(commodityClass.matches("^[a-zA-Z0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Commodity Class must be between 1 and 12 characters and alphanumeric.</span>");
			return null;
		}
		...
		if(!(commodityPieces.length() <= 64 && commodityPieces.length() > 0) || !(commodityPieces.matches("^[0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Commodity Pieces must be between 1 and 64 characters long and numeric.</span>");
			return null;
		}
		...
		if(!(commodityPaidWeight.length() <= 16 && commodityPaidWeight.length() > 0) || !(commodityPaidWeight.matches("^[0-9.]*\\.?[0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Commodity Paid Weight must be between 1 and 16 characters long and numeric.</span>");
			return null;
		}
		...
		if(!(shipperCity.length() <= 64 && shipperCity.length() > 0) || !(shipperCity.matches("^[A-Za-z]+(?:[\\s-][A-Za-z]+)*$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Shipper City must be between 1 and 64 characters and is alphabetic.</span>");
			return null;
		}
		...
		if(!(states.contains(shipperState) || stateAbbreviations.contains(shipperState))) {
			...
			session.setAttribute("message", "<span style='color:red'>Shipper State must be a state or state abbreviation.</span>");
			return null;
		}
		...
		if(!(shipperZip.length() <= 12 && shipperZip.length() > 0) || !(shipperZip.matches("^[0-9.]+$"))){
			...
			session.setAttribute("message", "<span style='color:red'>Shipper Zip must be between 1 and 12 characters and is numeric.</span>");
			return null;
		}
		...
		if(!(shipperLatitude.matches("^(-?[0-8]?\\d(\\.\\d{1,7})?|90(\\.0{1,7})?)$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Shipper Latitude must be between 90 and -90 up to 7 decimal places.</span>");
			return null;
		}
		...
		if(!(shipperLongitude.matches("^-?(180(\\.0{1,7})?|\\d{1,2}(\\.\\d{1,7})?|1[0-7]\\d(\\.\\d{1,7})?|-180(\\.0{1,7})?|-?\\d{1,2}(\\.\\d{1,7})?)$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Shipper Longitude must be between -180 and 180 up to 7 decimal places.</span>");
			return null;
		}
		...
		if(!(consigneeCity.length() <= 64 && consigneeCity.length() > 0) || !( consigneeCity.matches("^[A-Za-z]+(?:[\\s-][A-Za-z]+)*$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Consignee City must be between 1 and 64 characters and is alphabetic.</span>");
			return null;
		}
		...
		if(!(states.contains(consigneeState) || stateAbbreviations.contains(consigneeState))) {
			...
			session.setAttribute("message", "<span style='color:red'>Consignee State must be a state or state abbreviation.</span>");
			return null;
		}
		...
		if(!(consigneeZip.length() <= 12 && consigneeZip.length() > 0) || !(consigneeZip.matches("^[0-9.]+$"))){
			...
			session.setAttribute("message", "<span style='color:red'>Consignee Zip must be between 1 and 12 characters and is alphabetic.</span>");
			return null;
		}
		...
		if(!(consigneeLatitude.matches("^(-?[0-8]?\\d(\\.\\d{1,7})?|90(\\.0{1,7})?)$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Consignee Latitude must be between 90 and -90 up to 7 decimal places.</span>");
			return null;
		}
		...
		if(!(consigneeLongitude.matches("^-?(180(\\.0{1,7})?|\\d{1,2}(\\.\\d{1,7})?|1[0-7]\\d(\\.\\d{1,7})?|-180(\\.0{1,7})?|-?\\d{1,2}(\\.\\d{1,7})?)$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Consignee Longitude must be between 180 and -180 up to 7 decimal places.</span>");
			return null;
		}
		Shipments shipment = new Shipments();
		...
		try {
			for(int i=1; i<worksheet.getPhysicalNumberOfRows(); i++) {
	    		...
	    		if(allVehicleTypes.contains(make + " " + model)) {
	    			session.setAttribute("message", "<span style='color:red'>Can not upload mulitple Vehicle Types with the same make and model.</span>");
	...
	public VehicleTypes validateVehicleTypes(Hashtable<String, String> hashtable, HttpSession session) {
		...
		if(allVehicleTypes.contains(make + " " + model)) {
			...
			session.setAttribute("message", "<span style='color:red'>Vehicle Type make and model aleady exists.</span>");
			return null;
		}
		...
		if (!(type.length() <= 32 && type.length() > 0) || !(type.matches("^[a-zA-Z ]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Type was not between 1 and 32 alphabetic characters long.</span>");
			return null;	
		}
		...
		if (!(subType.length() <= 32 && subType.length() > 0) || !(subType.matches("^[a-zA-Z ]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Sub Type was not between 1 and 32 characters long.</span>");
			return null;	
		}
		...
		if (!(description == null || description.equals(""))) {
			if (!(description.length() <= 64 && description.length() > 0)) {
				...
				session.setAttribute("message", "<span style='color:red'>Description was not between 1 and 64 characters long.</span>");
				return null;	
			}
		}
		...
		if(!(make.length() <= 32 && make.length() > 0)) {
			...
			session.setAttribute("message", "<span style='color:red'>Make was not between 1 and 32 characters long.</span>");
			return null;
		}
		...
		if(!(model.length() <= 32 && model.length() > 0)) {
			...
			session.setAttribute("message", "<span style='color:red'>Model was not between 1 and 32 characters long.</span>");
			return null;
		}
		...
		if (!(minimumWeight.length() <= 16 && minimumWeight.length() > 0) || !(minimumWeight.matches("^[0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Minimum Weight was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if (!(maximumWeight.length() <= 16 && maximumWeight.length() > 0) || !(maximumWeight.matches("^[0-9.]+$"))) { 
			...
			session.setAttribute("message", "<span style='color:red'>Maximum Weight was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if (!(capacity == null || capacity.equals(""))) {
			if(!(capacity.length() <= 16 && capacity.length() > 0) || !(capacity.matches("^[0-9-.]+$"))) {
				...
				session.setAttribute("message", "<span style='color:red'>Capacity was not between 1 and 16 numeric characters long.</span>");
				return null;
			}
		}
		...
		if(!(maximumRange.length() <= 16 && maximumRange.length() > 0) || !(maximumRange.matches("^[0-9.]+$"))) {
			...
			session.setAttribute("message", " <span style='color:red'>Maximum Range was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if (!(restrictions == null || restrictions.equals(""))) {
			if(!(restrictions.length() <= 128 && restrictions.length() > 0)) {
				...
				session.setAttribute("message", "<span style='color:red'>Restrictions was not between 1 and 128 characters long.</span>");
				return null;
			}
		}
		...
		if(!(height.length() <= 16 && height.length() > 0) || !(height.matches("^[0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Height was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if(!(emptyWeight.length() <= 16 && emptyWeight.length() > 0) || !(emptyWeight.matches("^[0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Empty Weight was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if(!(length.length() <= 16 && length.length() > 0) || !( length.matches("^[0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Length was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if(!(minimumCubicWeight.length() <= 16 && minimumCubicWeight.length() > 0) || !(minimumCubicWeight.matches("^[0-9.]+$"))){
			...
			session.setAttribute("message", "<span style='color:red'>Minimum Cubic Weight was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
		...
		if(!(maximumCubicWeight.length() <= 16 && maximumCubicWeight.length() > 0) || !(maximumCubicWeight.matches("^[0-9.]+$"))){
			...
			session.setAttribute("message", "<span style='color:red'>Maximum Cubic Weight was not between 1 and 16 numeric characters long.</span>");
			return null;
		}
	...
	public List<Locations> validateLocationsSheet(XSSFSheet worksheet, HttpSession session){
		...
		try {
			for(int i=1; i<worksheet.getPhysicalNumberOfRows(); i++) {
	    		...
	    		if(allLocations.contains(locationName)) {
	    			...
	    			session.setAttribute("message", "<span style='color:red'>Can not upload multiple Locations with the same name.</span>");
	    			return null;
	    		}
		...
		public Locations validateLocations(Hashtable<String, String> hashtable, HttpSession session) {
			...
			if (!(locationName.length() <= 32 && locationName.length() > 0) || !(locationName.matches("^[a-zA-Z ']+$"))) { 
    			...
    			session.setAttribute("message", "<span style='color:red'>Name must be between 1 and 32 characters and alphabetic.</span>");
    			return null;
    		}
			
			if (allLocations.contains(locationName)) { 
    			Logger.error("{} || attempted to upload a location but a location with the same name already exists.",user.getUsername());
    			session.setAttribute("message", "<span style='color:red'>Location with the same name already exists.</span>");
    			return null;
    		}
    		...
    		if(!(streetAddress1.length() <= 64 && streetAddress1.length() > 0) || !(streetAddress1.matches("\\d+\\s+([a-zA-Z.]+\\s?)+"))) { 
    			...
    			session.setAttribute("message", "<span style='color:red'>Address must be between 1 and 64 characters that are alphanumeric.</span>");
    			return null;
    		}
    		...
    		if (!(streetAddress2 == null || streetAddress2.equals(""))) {
    			if(!(streetAddress2.length() <= 64 && streetAddress2.length() > 0) || !(streetAddress2.matches("^[A-Za-z0-9./-]+(?:[\\s-][A-Za-z0-9.-]+)*$"))) {
    				...
    				session.setAttribute("message", "<span style='color:red'>Street Address 2 must be between 1 and 64 characters that are alphanumeric.</span>");
    				return null;
    			}
    		}
    		...
    		if(!(locationCity.length() <= 64 && locationCity.length() > 0) || !(locationCity.matches("^[A-Za-z]+(?:[\\s-][A-Za-z]+)*$"))) { 
    			...
    			session.setAttribute("message", "<span style='color:red'>City must be between 1 and 64 characters and is alphabetic.</span>");
    			return null;
    		}
    		...
    		if(!(states.contains(locationState) || stateAbbreviations.contains(locationState))) {  
    			...
    			session.setAttribute("message", "<span style='color:red'>State must be a state or state abbreviation.</span>");
    			return null;
    		}
    		...
    		if(!(locationZip.length() <= 12 && locationZip.length() > 0) || !(locationZip.matches("^[0-9.]+$"))){ 
    			...
    			session.setAttribute("message", "<span style='color:red'>Zip must be between 1 and 12 characters and is numeric.</span>");
    			return null;
    		}
    		...
    		if(!(locationLatitude.length() <= 13 && locationLatitude.length() > 0) || !(locationLatitude.matches("^(-?[0-8]?\\d(\\.\\d{1,7})?|90(\\.0{1,7})?)$"))){ 
    			...
    			session.setAttribute("message", "<span style='color:red'>Latitude must be between 90 and -90 up to 7 decimal places.</span>");
    			return null;
    		}
    		...
    		if(!(locationLongitude.length() <= 13 && locationLongitude.length() > 0) || !(locationLongitude.matches("^-?(180(\\.0{1,7})?|\\d{1,2}(\\.\\d{1,7})?|1[0-7]\\d(\\.\\d{1,7})?|-180(\\.0{1,7})?|-?\\d{1,2}(\\.\\d{1,7})?)$"))){ 
    			...
    			session.setAttribute("message", "<span style='color:red'>Longitude must be between -180 and 180 up to 7 decimal places.</span>");
    			return null;
    		}
    		...
    		if(!(locationType.length() <= 64 && locationType.length() > 0) || !(locationType.matches("^[a-zA-Z ]+$"))){ 
    			...
    			session.setAttribute("message", "<span style='color:red'>Type must be 1 to 32 alphabetic characters.</span>");
    			return null;
    		}
	...
	public List<Contacts> validateContactsSheet(XSSFSheet worksheet, HttpSession session){
		...
		try {
			for(int i=1; i<worksheet.getPhysicalNumberOfRows(); i++) {
	    		...
	    		if(allContacts.contains(firstName + " " + lastName)) {
	    			...
	    			session.setAttribute("message", "<span style='color:red'>Cannot upload multiple Contacts with the same first and last name.</span>");
	    			return null;
	    		}
	    		result.add(contact);
			}
		...
		public Contacts validateContact(Hashtable<String, String> hashtable, HttpSession session) {
			...
			for(Contacts c: repoContacts) {
				...
				session.setAttribute("message","<span style='color:red'>contact with the same First Name and Last Name already exists</span>");
    			return null;
			}
			...
			if (!(firstName.length() <= 32 && firstName.length() > 0) || !(firstName.matches("^[a-zA-Z ']+$"))) { 
    			...
    			session.setAttribute("message", "<span style='color:red'>First name field must be between 1 and 32 characters and alphabetic.</span>");
    			return null;
    		}
    		...
    		if(!(lastName.length() <= 32 && lastName.length() > 0) || !(lastName.matches("^[a-zA-Z ']+$"))) {
    			...
    			session.setAttribute("message", "<span style='color:red'>Last name field must be between 1 and 32 characters and alphbetic.</span>");
    			return null;
    		}
    		if (!(middleInitial == null || middleInitial.equals(""))) {
    			if(!(middleInitial.length() <= 16 && middleInitial.length() > 0) || !(middleInitial.matches("^[A-Za-z]{1}$"))) {
    				...
    				session.setAttribute("message", "<span style='color:red'>Middle initial must be 1 character and alphabetic.</span>");
    				return null;
    			}
    		}
    		...
    		if(!(emailAddress.length() <= 64 && emailAddress.length() > 0) || !(emailAddress.matches("^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+$"))){
    			...
    			session.setAttribute("message", "<span style='color:red'>Email address must be between 1 and 64 characters that are alpahnumeric.</span>");
    			return null;
    		}
    		...
    		if(!(streetAddress1.length() <= 64 && streetAddress1.length() > 0)) { 
    			...
    			session.setAttribute("message", "<span style='color:red'>Street address 1 must be between 1 and 128 characters.</span>");
    			return null;
    		}
    		...
    		if (!(streetAddress2 == null || streetAddress2.equals(""))) {
    			if(!(streetAddress2.length() <= 64 && streetAddress2.length() > 0)) { 
    				...
    				session.setAttribute("message", "<span style='color:red'>Street address 2 must be between 1 and 64 characters.</span>");
    				return null;
    			}
    		}
    		...
    		if(!(contactZip.length() <= 12 && contactZip.length() > 0) || !(contactZip.matches("^[0-9.]+$"))){ 
    			...
    			session.setAttribute("message", "<span style='color:red'>Zip must be between 1 and 12 numeric characters.</span>");
    			return null;
    		}
    		...
    		if(!(primaryPhone.length() <= 13 && primaryPhone.length() > 0) || !(primaryPhone.matches("\\d{3}-\\d{3}-\\d{4}"))){ 
    			...
    			session.setAttribute("message", "<span style='color:red'>Primary phone must be in format ###-###-####.</span>");
    			return null;
    		}
    		...
    		if (!(workPhone == null || workPhone.equals(""))) {
    			if(!(workPhone.length() <= 13 && workPhone.length() > 0) || !(workPhone.matches("\\d{3}-\\d{3}-\\d{4}"))){ 
    				...
    				session.setAttribute("message", "<span style='color:red'>Work phone must be must be in format ###-###-####.</span>");
    				return null;
    			}
    		}
			 ...
			 try {	
				...
				for(int i=1; i<worksheet.getPhysicalNumberOfRows(); i++) {
		    		...
		    		if(allTechnicians.contains(contactFullName)) {
		    			...
		    			session.setAttribute("message", "<span style='color:red'>Can not upload multiple Technicians with the same Contact name.</span>");
		    			return null;
		    		}
	...
	public Technicians validateTechnicians(Hashtable<String, String> hashtable, HttpSession session) {
		...
		for(Technicians t : repoTechnicians) {
			if ((t.getContact().getFirstName() + " " + t.getContact().getLastName()).equals(contactFullName)) {
				...
				session.setAttribute("message", "<span style='color:red'>Technician already exists with this Contact name.</span>");
				return null;
			}
		}
		...
		if (!(skillGrade.length() <= 12 && skillGrade.length() > 0) || !(skillGrade.matches("^[a-zA-Z0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Skill Grade was not between 1 and 12 alphanumeric characters long.</span>");
			return null;	
		}
		
		if (contactId == null) {
			Logger.error("{} || attempted to upload a Technician but the Contact did not exist.",user.getUsername());
			session.setAttribute("message", "<span style='color:red'>Contact did not exist.</span>");
			return null;	
		}
		...
		try {
			for(int i=1; i<worksheet.getPhysicalNumberOfRows(); i++) {
	    		...
	    		if(allVehicles.contains(plate + " " + vin)) {
	    			...
	    			session.setAttribute("message", "<span style='color:red'>Can not upload multiple Vehicles with the same Plate and Vin.</span>");
	    			return null;
	    		}
	...
	public Vehicles validateVehicles(Hashtable<String, String> hashtable, HttpSession session) {
		...
		for(Vehicles v: repoVehicles) {
			...
			session.setAttribute("message", "<span style='color:red'>Vehicle already exists.</span>");
				return null;
		}
		
		if(vehicleTypeId == null) {
			Logger.error("{} || attempted to upload a Vehicle but the Vehicle Type did not exist.",user.getUsername());
			session.setAttribute("message", "<span style='color:red'>Vehicle Type did not exist.</span>");
			return null;	
		}
		
		if(locationId == null) {
			Logger.error("{} || attempted to upload a Vehicle but the Location did not exist.",user.getUsername());
			session.setAttribute("message", "<span style='color:red'>Location did not exist.</span>");
			return null;	
		}
		...
		if (!(plate.length() <= 12 && plate.length() > 0) || !(plate.matches("^[a-zA-Z0-9. -]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Plate was not between 1 and 12 alphanumeric characters long.</span>");
			return null;	
		}
		...
		if (!(vin.length() <= 17 && vin.length() > 0) || !(vin.matches("^[a-zA-Z0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Vin was not between 1 and 17 alphanumeric characters long.</span>");
			return null;	
		}
		...
		if (!(manufacturedYear.length() <= 4 && manufacturedYear.length() > 0) || !(manufacturedYear.matches("^[0-9]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Year was not between 1 and 4 numeric characters long.</span>");
			return null;	
		}	
			 ...
			 try {	
				...
				for(int i=1; i<worksheet.getPhysicalNumberOfRows(); i++) {
		    		...
		    		if(allDrivers.contains(contactFullName)) {
		    			...
		    			session.setAttribute("message", "<span style='color:red'>Can not upload multiple Drivers with the same Contact name.</span>");
		    			return null;
		    		}
			...
			public Driver validateDriver(Hashtable<String, String> hashtable, HttpSession session) {
				...
				for(Driver d : repoDrivers) {
					if ((d.getContact().getFirstName() + " " + d.getContact().getLastName()).equals(contactFullName)) {
						...
						session.setAttribute("message", "<span style='color:red'>Driver with this Contact already exists.</span>");
						return null;
					}
				}
				...
				if(vehicleId == null) {
					...
					session.setAttribute("message", "<span style='color:red'>Vehicle did not exist.</span>");
					return null;
				}
	    		...
	    		if(!(licenseNumber.length() <= 32 && licenseNumber.length() > 0)){
	    			...
	    			session.setAttribute("message", "<span style='color:red'>License number must be between 1 and 12 characters.</span>");
	    			return null;
	    		}
	    		...
	    		if(!(licenseClass.length() <= 12 && licenseClass.length() > 0) || !(licenseClass.matches("^[a-zA-Z-/]+$"))) { 
	    			...
	    			session.setAttribute("message", "<span style='color:red'>License class must be between 1 and 12 characters.</span>");
	    			return null;
	    		}
	...
	public MaintenanceOrders validateMaintenanceOrder(Hashtable<String, String> hashtable, HttpSession session) {
		...
		if(technicianId == null) {
			...
			session.setAttribute("message", "<span style='color:red'> Technician did not exist.</span>");
			return null;
		}
		...
		if (!(details == null || details.equals(""))) {
			if(!(details.length() <= 128 && details.length() > 0)) {
				...
				session.setAttribute("message", "<span style='color:red'>Details must be between 1 and 128 characters.</span>");
				return null;
			}
		}
		...
		if(!(serviceType.length() <= 12 && serviceType.length() > 0) || !(serviceType.matches("^[a-zA-Z0-9.]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Service Type must be between 1 and 12 alphanumeric characters.</span>");
			return null;
		}
		...
		if (!(cost == null || cost.equals(""))) {
			if(!(cost.length() <= 16 && cost.length() > 0) || !(cost.matches("^[0-9.]+$"))) {
				...
				session.setAttribute("message", "<span style='color:red'>Cost must be between 1 and 16 numeric characters.</span>");
				return null;
			}
		}
		...
		if(!(status.length() <= 64 && status.length() > 0)) {
			...
			session.setAttribute("message", "<span style='color:red'>Status must be between 1 and 64 characters.</span>");
			return null;
		}
		...
		if(!(type.length() <= 64 && type.length() > 0) || !(type.matches("^[a-zA-Z0-9. ]+$"))) {
			...
			session.setAttribute("message", "<span style='color:red'>Type must be between 1 and 64 characters.</span>");
			return null;
		}
	...
	public Contacts validateContactForm(Hashtable<String, String> hashtable, HttpSession session) {
		...
		if(!(states.contains(contactState) || stateAbbreviations.contains(contactState))) {  
			...
			session.setAttribute("message", "<span style='color:red'>State must be selected.</span>");
			return null;
		}
		...
		if(!(contactZip.length() == 5) || !(contactZip.matches("^[0-9.]+$"))){ 
			...
			session.setAttribute("message", "<span style='color:red'>Zip must be 5 numeric characters.</span>");
			return null;
		}
...
public Locations validateLocationsForm(Hashtable<String, String> hashtable, HttpSession session) {
	...
	if(!(locationZip.length() == 5) || !(locationZip.matches("^[0-9.]+$"))){ 
		...
		session.setAttribute("message", "<span style='color:red'>Zip must 5 numeric characters.</span>");
		return null;
	}
	...
	public Driver validateDriverForm(Hashtable<String, String> hashtable, HttpSession session) {
		...
		if(!(licenseExpiration.length() <= 12 && licenseExpiration.length() > 0) || !(licenseExpiration.matches("^\\d{2}-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-\\d{4}$"))){ 
			...
			session.setAttribute("message", "<span style='color:red'>Date must be between 1 and 12 characters and formated DD-MMM-YYYY.</span>");
			return null;
		}
	...
	public MaintenanceOrders validateMaintenanceOrderForm(Hashtable<String, String> hashtable, HttpSession session) {
		...
		if (!(details == null || details.equals(""))) {
			if(!(details.length() <= 128 && details.length() > 0)) {
				Logger.error("{} || attempted to edit a Maintenance Order but the Details must be between 1 and 128 characters.</span>",user.getUsername());
				session.setAttribute("message", "<span style='color:red'>Details must be between 1 and 128 characters.");
				return null;
			}
		}
